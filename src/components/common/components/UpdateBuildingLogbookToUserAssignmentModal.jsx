...
class UpdateUseruserAssigmentModal extends Component {
  ...
  getAssignBuildingLogbookForUserPopupDetails = async () => {
    ...
    const {
      commonReducer: {
        getAssignBuildingLogbookToUserPopupDetailsResponse: { user, available_building_logbooks = [], assigned_building_logbooks = [], success }
      }
    } = this.props;
    if (success) {
      await this.setState({
        ...
        <div className="modal assigned-build-modal three-col-modal" role="dialog" style={{ display: "block" }} id="modalId">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <BuildModalHeader title="Assign Building Logbooks For User" onCancel={this.cancelModal} modalClass="assigned-build-modal" />
                    ...
                    <div className="outer-avl-bind">
                      <div className="sr-sec search-section">
                        <div className="sr-out">
                          ...
                          />
                          <span className="clear-btn" onClick={() => (availableSearchKey.trim().length ? this.searchInAvailable("") : null)}>
                            Clear
                          </span>
                        </div>
                      </div>
                          ...
                          <thead>
                            <tr>
                              <th className="img-sq-box">
                                <span className="material-icons icon-arw" onClick={() => this.updateAssignedList("add", "all")}>
                                  height
                                </span>
                              </th>
                                ...
                                <tr key={i}>
                                  <td className="img-sq-box">
                                    <span
                                      ...
                                      onClick={() => this.updateAssignedList("add", item.id, "available_building_logbooks")}
                                    >
                                      height
                                    </span>
                                  </td>
                    ...
                    <div className="outer-avl-bind">
                      <div className="sr-sec search-section">
                        <div className="sr-out">
                          ...
                          />
                          <span className="clear-btn" onClick={() => (assignedSearchKey.trim().length ? this.searchInAssigned("") : null)}>
                            Clear
                          </span>
                        </div>
                      </div>
                      <div className="table-section">
                        <table className="table table-bordered file-system-table">
                          <thead>
                            <tr>
                              <th className="img-sq-box">
                                <span className="material-icons icon-arw" onClick={() => this.updateAssignedList("remove", "all")}>
                                  height
                                </span>
                              </th>
                              <th>Building Logbook</th>
                          ...
                          <tbody>
                            {assigned_building_logbooks && assigned_building_logbooks.length ? (
                              assigned_building_logbooks.map((item, i) => (
                                <tr key={i}>
                                  <td className="img-sq-box">
                                    <span className="material-icons icon-arw" onClick={() => this.updateAssignedList("remove", item.id)}>
                                      height
                                    </span>
                                  </td>
                                  <td>
